...
//========================================================================================
    ...
    Flux<User> fluxWithLog() {
        return repository.findAll().doOnNext(System.out::println);
    }
...
//========================================================================================
    ...
    Flux<User> fluxWithDoOnPrintln() {
        return repository.findAll().doOnSubscribe(x -> System.out.println("Starring")).doOnNext(user -> System.out.println(user.getFirstname() + " " + user.getLastname())).doOnComplete(() -> System.out.println("The end!"));
    }
